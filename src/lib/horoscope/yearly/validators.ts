// ============================================================
// Yearly Horoscope Engine — Validators
// ============================================================

import { RASHI_KEYS, SUPPORTED_LANGUAGES } from "../constants";
import type { YearlyHoroscopeInput, YearlyValidationResult } from "./types";

export function validateYearlyInput(input: YearlyHoroscopeInput): YearlyValidationResult {
  const errors: YearlyValidationResult["errors"] = [];
