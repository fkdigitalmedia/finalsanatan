/** Phase 14.7 — programmatic landing page for a single numerology. */
...
function descriptor(slug: string) {
  const entity = findEntity("numerology", slug);
  return {
    entity,
    seo: entity
      ? {
          type: "landing" as const,
          path: `/numerology/${entity.slug}`,
          slug: entity.slug,
          title: entity.title,
...
export const Route = createFileRoute("/numerology/$slug")({
  head: ({ params }) => {
