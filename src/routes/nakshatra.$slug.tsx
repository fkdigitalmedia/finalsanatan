/** Phase 14.7 — programmatic landing page for a single nakshatra. */
...
function descriptor(slug: string) {
  const entity = findEntity("nakshatra", slug);
  return {
    entity,
    seo: entity
      ? {
          type: "landing" as const,
          path: `/nakshatra/${entity.slug}`,
          slug: entity.slug,
          title: entity.title,
...
export const Route = createFileRoute("/nakshatra/$slug")({
  head: ({ params }) => {
