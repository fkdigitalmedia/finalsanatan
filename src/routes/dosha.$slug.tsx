/** Phase 14.7 — programmatic landing page for a single dosha. */
...
const FAMILY = ENTITY_FAMILIES.dosha;

function descriptor(slug: string) {
  const entity = findEntity("dosha", slug);
  return {
    entity,
    seo: entity
      ? {
          type: "landing" as const,
          path: `/dosha/${entity.slug}`,
          slug: entity.slug,
          title: entity.title,
...
export const Route = createFileRoute("/dosha/$slug")({
  head: ({ params }) => {
