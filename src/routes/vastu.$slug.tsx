/** Phase 14.7 — programmatic landing page for a single vastu. */
...
const FAMILY = ENTITY_FAMILIES.vastu;

function descriptor(slug: string) {
  const entity = findEntity("vastu", slug);
  return {
    entity,
    seo: entity
      ? {
          type: "landing" as const,
          path: `/vastu/${entity.slug}`,
          slug: entity.slug,
          title: entity.title,
...
export const Route = createFileRoute("/vastu/$slug")({
  head: ({ params }) => {
