/** Phase 14.7 — programmatic landing page for a single rashi. */
...
function descriptor(slug: string) {
  const entity = findEntity("rashi", slug);
  return {
    entity,
    seo: entity
      ? {
          type: "landing" as const,
          path: `/rashi/${entity.slug}`,
          slug: entity.slug,
          title: entity.title,
...
export const Route = createFileRoute("/rashi/$slug")({
  head: ({ params }) => {
